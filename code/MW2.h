...
typedef void (__cdecl * Com_StartupVariable_t)( const char *match );
extern Com_StartupVariable_t Com_StartupVariable;
...
typedef pack_t* (__cdecl * FS_LoadZipFile_t)(const char *zipfile, const char *basename);
...
typedef int (__cdecl * unzClose_t)(void*);
